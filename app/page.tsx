              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl">
                    A transparent, verifiable package tracking system powered by
                    blockchain technology. No more lost packages or fake
                    delivery updates.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">
                  Why Choose dPackChain?
                </h2>
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Our blockchain-powered shipping platform offers transparency
                  and reliability that traditional systems can't match.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-3 lg:gap-12 pt-8">
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-gray-500">
                  Every shipment update is permanently recorded on the
              ...
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-gray-500">
                  Get instant notifications and track your package's journey
                  with accurate, real-time status updates.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-6 shadow-sm">
                ...
                <p className="text-center text-gray-500">
                  Access delivery speed stats, average delays by area, and other
                  analytics powered by Pharos.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container max-w-screen-xl px-4 md:px-6 mx-auto">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-4 pt-12">
              <div className="flex flex-col items-center space-y-2 text-center">
                ...
                <p className="text-sm text-gray-500">
                  Seller registers the shipment on-chain with sender, receiver,
                  and package details.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 text-center">
                ...
                <p className="text-sm text-gray-500">
                  Delivery updates are recorded via smart contract events as the
                  package moves.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 text-center">
                ...
                <p className="text-sm text-gray-500">
                  Users enter their Tracking ID to view real-time status and
              ...
              <div className="flex flex-col items-center space-y-2 text-center">
                ...
                <p className="text-sm text-gray-500">
                  Final delivery is signed by receiver via wallet signature or
                  OTP verification.
                </p>
              </div>
            </div>
