...
import { ArrowLeft, CheckCircle, Menu, Package } from "lucide-react";
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <header className="border-b">
        <div className="mx-auto w-full max-w-screen-xl flex h-16 items-center justify-between px-4 md:px-6">
        ...
        {menuOpen && (
          <div className="md:hidden flex flex-col items-start px-4 py-2 gap-2 border-t">
            ...
            <Link href="/track" className="text-sm font-medium">
              Track Package
            </Link>
          </div>
        )}
        ...
        {isSuccess ? (
          <Card className="max-w-3xl mx-auto">
            <CardHeader>
              ...
              <CardDescription>
                Your shipment has been registered on the blockchain and is ready
                to be tracked.
              </CardDescription>
            </CardHeader>
              ...
              <div className="rounded-lg border p-4 bg-gray-50">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">
                    Share this tracking number with the recipient so they can
                    track the package.
                  </p>
                </div>
              </div>
          ...
          <Card className="max-w-3xl mx-auto">
            <CardHeader>
              ...
              <CardDescription>
                Enter the shipment details to register it on the blockchain.
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div className="grid gap-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <p className="text-xs text-gray-500">
                        If provided, the receiver will need to sign with this
                        wallet to confirm delivery.
                      </p>
                    </div>
                  </div>
                </div>
